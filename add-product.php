            ...
            <form action="" method="post">
                <div class="form-group mb-2">
                    ...
                    <div class="input-required">
                        <input type="text" class="form-control" id="" name="productName" placeholder="Digite o nome do produto">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-required">
                        <input type="number"  class="form-control" id="" name="amount" placeholder="Quantidade desejada">
                ...
                <div class="mb-0">
                    ...
                    <div class="input-required">
                        <input type="text" class="form-control" id="" name="price" placeholder="Preço do produto">
                ...
                <div class="buttons">
                    ...
                    <a href="show-products.php" class="btn btn-success">Mostrar Carrinho</a>
                </div>
            </form>
        </div>
    </div>
